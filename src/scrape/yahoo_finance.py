...
class YahooFinanceDownloader:
    ...
    def run(self, symbol, start_date="2018-01-01", end_date="2025-07-01", interval="1d", output_dir="data"):
        """
        ...
        try:
            ...
            if data.empty:
                raise ValueError(f"No data found for symbol {symbol} in the specified period")
