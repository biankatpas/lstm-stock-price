...
class PrepareSequence:
    ...
    def create_sequences(self, data: np.ndarray, target_column_index: int = 0) -> Tuple[np.ndarray, np.ndarray]:
        """
        Args:
    ...
    def split_sequences(self, X: np.ndarray, y: np.ndarray, test_size: float = 0.3) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
        """
        Args:
    ...
    def create_train_test_sequences(self, data: np.ndarray, target_column_index: int = 0, 
